# framework = xUnit | regeneration.mode = Update | labels = false

```bash
alchemist --solution ./Example.sln --framework xUnit --regeneration.mode Update --regeneration.labels false
```
